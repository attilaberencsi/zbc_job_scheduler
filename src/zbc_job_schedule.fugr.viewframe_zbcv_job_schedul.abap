*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZBCV_JOB_SCHEDUL
*   generation date: 20.10.2016 at 10:18:53 by user BERENCSI_A
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZBCV_JOB_SCHEDUL    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZBCV_JOB_SCHEDUL'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZBCV_JOB_SCHEDUL_EXTRACT
TOTAL = ZBCV_JOB_SCHEDUL_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZBCV_JOB_SCHEDUL'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZBCV_JOB_SCHEDUL-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZBCV_JOB_SCHEDUL_EXTRACT
TOTAL = ZBCV_JOB_SCHEDUL_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZBCV_JOB_SCHEDUL-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZBCV_JOB_SCHEDUL'
...
TOTAL = ZBCV_JOB_SCHEDUL_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZBCV_JOB_SCHEDUL-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZBCV_JOB_SCHEDUL-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZBCV_JOB_SCHEDUL'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZBCV_JOB_SCHEDUL-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZBCV_JOB_SCHEDUL_EXTRACT
TOTAL = ZBCV_JOB_SCHEDUL_TOTAL
